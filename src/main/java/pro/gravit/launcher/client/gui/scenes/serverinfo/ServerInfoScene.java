...
import static pro.gravit.launcher.client.gui.scenes.servermenu.ServerMenuScene.downloadJsonFromUrl;
...
public class ServerInfoScene extends AbstractScene {
    ...
    public void reset() throws Exception {
        //Получение категорий сервера

        String jsonData = downloadJsonFromUrl(ServerMenuScene.getJSON_URL().toString());
        JSONParser parser = new JSONParser();
        JSONObject jsonObject = (JSONObject) parser.parse(jsonData);
        JSONObject categorys_list = (JSONObject) jsonObject.get("servers");
        JSONObject categorys_name = (JSONObject) jsonObject.get("category_list");
        ...
        serverButton = ServerMenuScene.getServerButton(application, profile, jsonObject);
